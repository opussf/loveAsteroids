...
game.angleTable = require "angleTable"
game.shapes = require "shapes"
...
-- game
function game.init()
	game.eventq = events.new()
	game.player = player.new( game.eventq, game.center )

	print(game.player, game.player.__coords[1], game.player.__coords[2])
end
